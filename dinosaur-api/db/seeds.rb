...
Dinosaur.create(genus: "Nodocephalosaurus", grouping: "Ankylosauria", meaning: "Node-headed Lizard", type_species: "N. kirtlandensis", discovery_year: 1999, discovery_person: "Sullivan", size: 6, period: "Late Cretaceous", distribution: "New Mexico", description: "The skull of this animal is high and arched, and the armor on the head is distinctive.")
Dinosaur.create(genus: "Anchisaurus", grouping: "Prosauropod", meaning: "Near Lizard", type_species: "A. major", discovery_year: 1885, discovery_person: "Marsh", size: 2.5, period: "Jurassic", distribution: "New England", description: "Not recognized as a dinosaur until 1885.")